Cross-compiliation of Trivechain Core
===============================

Trivechain Core can be cross-compiled on Linux to all other supported host systems. This is done by changing
...
When building Trivechain Core, use
