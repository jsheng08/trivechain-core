...
For example, to connect as `root` from a Linux command prompt use
    ...
    individual files in /usr/share/docs/*/copyright.
...
Follow the instructions in [docs/release-process.md](release-process.md#fetch-and-create-inputs-first-time-or-when-dependency-versions-change)
in the Trivechain Core repository under 'Fetch and create inputs' to install sources which require
...
Gitian builds' in [docs/release-process.md](release-process.md#perform-gitian-builds) in the Trivechain Core repository.
