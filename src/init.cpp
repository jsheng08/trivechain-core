...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-litemode", strprintf(_("Disable all Trivechain specific functionality (Masternodes, PrivateSend, DirectSend, Governance) (0-1, default: %u)"), 0));
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/trivechain/trivechain-core>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Trivechain Core version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    if(fLiteMode) {
        InitWarning(_("You are starting in lite mode, most Trivechain-specific functionality is disabled."));
    }
    ...
    // ********************************************************* Step 10b: schedule Trivechain-specific tasks
