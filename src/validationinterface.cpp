...
struct MainSignalsInstance {
    ...
    boost::signals2::signal<void (const CTransaction &tx, const llmq::CDirectSendLock& islock)>NotifyTransactionLock;
...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.m_internals->NotifyDirectSendDoubleSpendAttempt.connect(boost::bind(&CValidationInterface::NotifyDirectSendDoubleSpendAttempt, pwalletIn, _1, _2));
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.m_internals->NotifyDirectSendDoubleSpendAttempt.disconnect(boost::bind(&CValidationInterface::NotifyDirectSendDoubleSpendAttempt, pwalletIn, _1, _2));
...
void UnregisterAllValidationInterfaces() {
    ...
    g_signals.m_internals->NotifyDirectSendDoubleSpendAttempt.disconnect_all_slots();
...
void CMainSignals::NotifyTransactionLock(const CTransaction &tx, const llmq::CDirectSendLock& islock) {
...
void CMainSignals::NotifyDirectSendDoubleSpendAttempt(const CTransaction &currentTx, const CTransaction &previousTx) {
        m_internals->NotifyDirectSendDoubleSpendAttempt(currentTx, previousTx);
}
