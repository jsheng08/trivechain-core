...
protected:
    ...
    virtual void NotifyTransactionLock(const CTransaction &tx, const llmq::CDirectSendLock& islock) {}
...
public:
    ...
    void NotifyTransactionLock(const CTransaction &tx, const llmq::CDirectSendLock& islock);
    ...
    void NotifyDirectSendDoubleSpendAttempt(const CTransaction &currentTx, const CTransaction &previousTx);
