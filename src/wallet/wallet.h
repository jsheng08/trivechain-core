...
public:
    ...
    /// Get 10000 TRVC output and keys which can be used for the Masternode
    ...
    void NotifyTransactionLock(const CTransaction &tx, const llmq::CDirectSendLock& islock) override;
