...
void WalletTxToJSON(const CWalletTx& wtx, UniValue& entry)
{
    ...
    bool fLocked = llmq::quorumDirectSendManager->IsLocked(wtx.GetHash());
...
{
    if (request.fHelp) {
        throw std::runtime_error("directsendtoaddress is deprecated and sendtoaddress should be used instead");
    }
    LogPrintf("WARNING: Used deprecated RPC method 'directsendtoaddress'! Please use 'sendtoaddress' instead\n");
...
{ //  category              name                        actor (function)           okSafeMode
    ...
    { "hidden",             "directsendtoaddress",     &directsendtoaddress,     false,  {"address","amount","comment","comment_to","subtractfeefromamount"} },
