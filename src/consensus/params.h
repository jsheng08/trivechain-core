...
// See https://github.com/trivechain/dips/blob/master/dip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
struct Params {
    ...
    /** Block height at which DIP0003 becomes fully enforced */
    int DIP0003FullyEnforcementHeight;
    /**
