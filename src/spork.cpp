...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_2_DIRECTSEND_ENABLED,            4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_3_DIRECTSEND_BLOCK_FILTERING,    4070908800ULL), // OFF
    ...
    MAKE_SPORK_DEF(SPORK_16_DIRECTSEND_AUTOLOCKS,         4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_17_QUORUM_DKG_ENABLED,            4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_19_CHAINLOCKS_ENABLED,            4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_20_DIRECTSEND_LLMQ_BASED,        4070908800ULL), // OFF
};
